  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Emlak Arama</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Yönetim</a></li>
        <li class="active">Emlak Ara</li>
      </ol>
    </section>
			...
			<div class="box-body">
				<form action="" method = "post"  role="form">
					<div class="form-group">
					  ...
					  <input type="text" name = "baslik"   class="form-control" placeholder="İlan Başlığı">
					</div>
					<div class="form-group">
					  <label>İl Giriniz:</label>
					  <input type="text" name = "il"  class="form-control" placeholder="İl">
					</div>
					<div class="form-group">
					  <label>İlçe Giriniz:</label>
					  <input type="text" name = "ilce" class="form-control" placeholder="İlce">
					</div>
					<div class="form-group">
					  <label>Emlak Tipini Seçiniz</label>
					  <select onchange="duzenleme()"  id="tip" name="tip" class="form-control">
					...
					<div class="form-group">
					  ...
					  <input type="number" name = "metrekare"   class="form-control" placeholder="Metrekare">
					</div>
					<div class="form-group">
					  <label id="soru1">Salon Sayısı:</label>
					  <input type="number" id="salon" name = "salon"   class="form-control" placeholder="Salon">
					</div>
					<div class="form-group">
					  <label id="soru2">Oda Sayısı:</label>
					  <input type="number" id="oda" name = "oda"   class="form-control" placeholder="Oda">
					</div>
				...
				<?php 
					if($_POST)
					{
						...
						$ilanlar =$veritabani->arama($baslik,$il,$ilce,$tip,$metrekare,$oda,$salon);
